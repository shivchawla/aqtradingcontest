            ...
            <Grid container>
                ...
                <Grid item xs={12}>
                    <div style={{padding: '20px 40px', fontSize: '16px', textAlign: 'start'}}>
                        ...
                        <h1 style={{marginBottom: '40px', fontWeight: 400}}>Virtual Trading Contest Rules</h1>
                        <h3 style={h3Style}>Overview</h3>
                        <p>The Virtual Trading Contest at AdviceQube is a competition that awards the best stock pickers. The contest is based on Indian markets and designed to evaluate expert&rsquo;s ability to pick profitable trades/stocks using subset of trade-able equities on National Stock Exchange, India. Each participant is a given a virtual cash of 10 Lacs at the beginning of the contest.</p>
                        <p>&nbsp;</p>
                        ...
                        <p style={bulletStyle}>4. Participant&rsquo;s entry must not violate or infringe on any applicable law or regulation or third-party rights.</p>
                        <p style={bulletStyle}>5. Participant&rsquo;s intellectual property will remain Participant's property; However, we may look at Participant's Investment Portfolio for additional checks. We WILL NOT use participant&rsquo;s stock predictions without explicit consent. We WILL NEVER distribute participant&rsquo;s stock predictions to anyone, unless required by law..</p>
                        <p>&nbsp;</p>
                        ...
                        <p><strong>MONTHLY WINNERS: </strong>At the end of each trading month, we will calculate the change in NET VALUE from end of last month's net value. All applicable* winners will get 10% of the adjusted profits over the benchmark (Min. of 1%). However, ONLY a maximum of Rs. 25,000 will be awarded as prize money. The prizes will be awarded in order of decreasing profitability. Additionally, a high water mark (ending NAV must be greater than NAV of all previous months) test will be applicable to avoid double incentive.</p>
                        <p>&nbsp;</p>
